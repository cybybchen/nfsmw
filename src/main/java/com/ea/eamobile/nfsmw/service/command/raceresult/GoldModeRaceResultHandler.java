...
@Service
public class GoldModeRaceResultHandler extends BaseCommandService implements RaceResultHandler {
    ...
    Logger log = LoggerFactory.getLogger(GoldModeRaceResultHandler.class);

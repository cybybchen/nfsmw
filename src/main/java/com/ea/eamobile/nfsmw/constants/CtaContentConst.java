...
public class CtaContentConst {
    ...
    public static final String DAYS_NUM_REPLACE = "{days}";

    public static final String TRACK_NAME_REPLACE = "{content}";

    public static final String TIER_REPLACE = "{tier}";

    public static final String NEXT_TIER_REPLACE = "{nextTier}";
